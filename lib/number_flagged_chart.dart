...
class NumberFlaggedChart extends StatefulWidget {
  const NumberFlaggedChart({super.key});

  @override
  State<StatefulWidget> createState() => NumberFlaggedChartState();
}

class NumberFlaggedChartState extends State {
  int touchedIndex = -1;
              ...
              return Card(
                ...
                child: Column(
                  children: [
                    ...
                    const Center(
                        child: Text(
                      "Number of Flagged Loans and Grants",
                      style: TextStyle(
  ...
  List<PieChartSectionData> showingSections(dataPoints) {
    print(dataPoints["Flagged"][0]["value"]);
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            value: double.parse(
                dataPoints["Flagged"][0]["value"].replaceAll(",", "")),
            title: dataPoints["Flagged"][0]["value"],
            radius: radius,
        ...
        case 1:
          return PieChartSectionData(
            ...
            value: double.parse(
                dataPoints["Alert"][0]["value"].replaceAll(",", "")),
            title: dataPoints["Alert"][0]["value"],
            radius: radius,
            titleStyle: TextStyle(
              fontSize: fontSize,
              fontWeight: FontWeight.bold,
        ...
        case 2:
          return PieChartSectionData(
            ...
            value: double.parse(
                dataPoints["Satisfactory"][0]["value"].replaceAll(",", "")),
            title: dataPoints["Satisfactory"][0]["value"],
            radius: radius,
            titleStyle: TextStyle(
              fontSize: fontSize,
              fontWeight: FontWeight.bold,
